...
namespace Tibia.Objects
{
    public partial class Client
    {
        public class MemoryHelper
        {
            ...
            {
                return ReadBytes(client.ProcessHandle, address, 1)[0];
            }
            ...
            {
                return BitConverter.ToInt32(ReadBytes(client.ProcessHandle, address, 4), 0);
            }
            ...
            public string ReadString(long address, uint length)
            {
                ...
                {
                    byte[] buffer;
                    buffer = ReadBytes(client.ProcessHandle, address, length);
